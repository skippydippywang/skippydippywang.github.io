...
I was introduced to WOKWI which is an online electronic simulator. In WOKWI, I was able to porgram different microcontrollers with their repective programming languages to simulate circuits. For my first excersise I programmed an ESP32-S3 in C++ language. For the next 2 excersies, instead of using C++ to program, I used the micropython to progam the ESP32-S3 & the RP2040. For Excersie 4 I was tasked to use Generative AI chat to create a program for the ESP32-S3 to read input values from a potentiometer and use it to control the intensity of an LED.

Thr prompt that I use was "".
